About upstash-ratelimit-feedstock
=================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/upstash-ratelimit-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/upstash-ratelimit-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add upstash-ratelimit
# for installing globally
pixi global install upstash-ratelimit
```
...
It is possible to list all of the versions of `upstash-ratelimit` available on your platform:
...
```
pixi search upstash-ratelimit --channel conda-forge
```
